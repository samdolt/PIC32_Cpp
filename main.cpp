...
#pragma config FSOSCEN = OFF // Oscillateur secondaire d�sactiv�
#pragma config IESO = OFF // Internal External Switch Over bit Disable
#pragma config FNOSC = PRIPLL // Oscillateur primaire avec PLL
#pragma config OSCIOFNC = OFF // D�sactivation de la sortie sur la pin CLKO
...
#pragma config FPLLODIV = DIV_1 // Division par 1 -> 80MHz pour l'horloge syst�me
#define SYS_FREQ (80000000L)    // Constante stockant la valeur de l'horloge syst�me



/* Configuration du chien de garde (WATCHDOG)
 * ------------------------------------------ */
#pragma  config FWDTEN = OFF // D�sactiv�



/* Configuration du programmeur et du d�bogueur
 * -------------------------------------------- */
#pragma config ICESEL = ICS_PGx2 // Les pins ICE sont partag�e avec PGC2 et PGD2
#pragma config DEBUG = ON // Mode DEBUG enclench�
...
int main (void){
    ...
    mJTAGPortEnable(0); // D�sactivation du JTAG, lib�re RA0, RA1, RA4 et RA5
...
extern "C"
{
    // Les vecteurs d'interruption doivent �tre compil� en "mode" C
}